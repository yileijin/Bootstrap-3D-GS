...
def readColmapCameras(cam_extrinsics, cam_intrinsics, images_folder):
    ...
    for idx, key in enumerate(cam_extrinsics):
        ...
        cam_info = CameraInfo(uid=uid, R=R, T=T, qvec=extr.qvec, tvec=extr.tvec, FovY=FovY, FovX=FovX, image=image,
...
def readColmapSceneInfo(path, images, eval, lod=0, llffhold=8, train_llffhold=False):
    try:
