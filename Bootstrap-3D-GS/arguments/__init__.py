...
<<<<<<< HEAD:Bootstrap-3D-GS/arguments/__init__.py
=======
...
>>>>>>> b53cfcbdb5e9f260ad6b1013c160213ba2c8b656:arguments/__init__.py
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        # general image2image generation configs
        self.do_expension = True
        self.multi_scale = False
        self.exp_interval = 1000
        self.exp_start_iter = 6000
        self.exp_end_iter = 28000
        self.exp_iter_list = [6000, 9000, 12000, 15000, 18000, 21000, 24000, 27000]
        self.use_random_variant = True
        self.scene_variant_num = 2
        # qscale tscale
        self.random_noise_scales = [0.1, 0.2]
        self.exp_one_iter_only = True
        self.consecutive_expension = False
        self.bootstrap_interval = 1000
        self.loss_weight = [0.2, 0.05]
        self.save_novel_renderings = False
        self.gen_variant_path = "./variants_output/"
        self.img2img_model_path = "stabilityai/sdxl-turbo"
        self.img2img_lora_path = ""
        self.sd_device = "cuda"
        self.img2img_prompt = "truck, sharp, denoise, natural, detailed, 8k"  # "professional graph with sharp and natural detail"
        self.infer_one_step = True
        self.infer_steps = 100
        self.boot_batch = 1
        self.broken_strength = [0.1, 0.01]
        self.guidance_scale = 2.0
        self.eta = 0.3
        self.save_img2img_images = False
